    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <c:if test="${not empty message}">
                        <img style="padding: 0px;" src="${pageContext.request.contextPath}/images/register-03.svg"
                            alt="步驟3註冊成功">
                    </c:if>
                    <c:if test="${not empty error}">
                        <img style="padding: 0px;" src="${pageContext.request.contextPath}/images/register-06.svg"
                            alt="步驟3註冊成功">
                    </c:if>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <span style="font-size:35px;line-height: 50px;">${message} </span>
                                    ...
                                    <div style="font-size: 18px;color: #333;line-height:40px">
                                        <ul>
                                            <li><a href="${pageContext.request.contextPath}/index" tabindex="-1">首頁</a>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/topiclist.jsp?nav=sensor"
                                                    tabindex="-1">感測器</a></li>
                                            <li><a href="${pageContext.request.contextPath}/topiclist.jsp?nav=apparatus"
                                                    tabindex="-1">儀器儀表</a></li>
                                            <li><a href="${pageContext.request.contextPath}/topiclist.jsp?nav=Netcom"
                                                    tabindex="-1">網通裝置</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
