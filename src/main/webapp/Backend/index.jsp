...
<head>
    ...
    <script defer="defer" type="module" src="${pageContext.request.contextPath}/js/app.548a6386.js"></script>
    ...
    <script defer="defer" src="${pageContext.request.contextPath}/js/app-legacy.2dbce5be.js" nomodule></script>
</head>
