...
<head>
    ...
    <script defer="defer" type="module" src="${pageContext.request.contextPath}/js/app.a3f79498.js"></script>
    ...
    <script defer="defer" src="${pageContext.request.contextPath}/js/chunk-vendors-legacy.3b7c2bcd.js"
            nomodule></script>
    <script defer="defer" src="${pageContext.request.contextPath}/js/app-legacy.44d81660.js" nomodule></script>
</head>
