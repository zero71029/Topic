...
<head>
    ...
    <link href="${pageContext.request.contextPath}/icons/bootstrap-icons.css" rel="stylesheet">
    ...
    <script defer="defer" type="module" src="${pageContext.request.contextPath}/js/app.567c623a.js"></script>
